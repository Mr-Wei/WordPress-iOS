...
class FancyAlertViewController: UIViewController {
    ...
    private struct Constants {
        ...
        static let moreInfoFont = WPStyleGuide.fontForTextStyle(.subheadline, fontWeight: UIFont.Weight.semibold.rawValue)
    ...
    override func viewDidLoad() {
        ...
        WPStyleGuide.configureLabel(titleLabel, textStyle: .title2, fontWeight: UIFont.Weight.semibold.rawValue)
